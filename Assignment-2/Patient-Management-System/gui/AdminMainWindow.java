...
public class AdminMainWindow extends JFrame {
    ...
    private void createToolBar() {
        ...
        searchPatientBtn.addActionListener(e -> searchPatientByName());
    ...
    private void searchPatientByDisease() {
        ...
        List<Patient> patients = PatientDAO.getPatientsByDisease(diseaseName.trim());
    ...
    private void searchPatientByDoctor() {
        ...
        List<Patient> patients = PatientDAO.getPatientsByDoctor(doctorName.trim());
    ...
    private void printPatientList() {
        ...
        PrintUtility.printTable(table, "Patient List - " + new java.util.Date());
    }
    ...
    private void printDoctorList() {
        ...
        JTable table = new JTable(data, columnNames);
        PrintUtility.printTable(table, "Doctor List - " + new java.util.Date());
    }
    ...
    private void printDiseaseList() {
        ...
        JTable table = new JTable(data, columnNames);
        PrintUtility.printTable(table, "Disease List - " + new java.util.Date());
    }
